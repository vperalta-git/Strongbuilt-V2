  ...
  return (
    <section className="grid min-h-[78vh] place-items-center bg-ink pb-20 pt-40 text-white">
      <Container className="text-center">
        ...
        <Link href="/trucks" className="mt-8 inline-flex min-h-13 items-center gap-3 bg-white px-6 text-xs font-extrabold uppercase tracking-[0.14em] text-ink hover:bg-brand hover:text-ink"><ArrowLeft aria-hidden="true" className="h-4 w-4" />Browse trucks</Link>
      </Container>
    </section>
  )
}
